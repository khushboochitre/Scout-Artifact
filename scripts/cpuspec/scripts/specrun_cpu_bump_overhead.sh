...
runcpu --config=Native_jemalloc2k_bump --noreportable --tune=base --copies=1 --iteration=1 --action=clobber --size=$SIZE $BENCHMARK >> output.txt
runcpu --config=Native_jemalloc2k_bump --noreportable --tune=base --copies=1 --iteration=$ITER --size=$SIZE $BENCHMARK >> output.txt
