...
runcpu --config=Scout --noreportable --tune=base --copies=1 --iteration=1 --action=clobber --size=$SIZE $BENCHMARK >> output.txt
runcpu --config=Scout --noreportable --tune=base --copies=1 --iteration=$ITER --size=$SIZE $BENCHMARK >> output.txt
