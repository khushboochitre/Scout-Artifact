...
NATIVE_JEMALLOC_FLAGS="-mllvm -disable-additional-vectorize -O3 -g -allocator2k"
RESTRICT="-DPOLYBENCH_USE_RESTRICT"

NATIVE_LIB_FLAGS="-L$JEMALLOC2k -ljemalloc1 -lsupport"

iter=5
BENCHMARK="gesummv 2mm 3mm bicg doitgen jacobi-1d"
...
do
    ...
    then
        ...
        $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/datamining/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/datamining/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
            cd $EXE_FILES/ && tmptime=`./$val`
    ...
    then
        ...
        $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/linear-algebra/blas/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/linear-algebra/blas/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
            cd $EXE_FILES/ && tmptime=`./$val`
    ...
    then
        ...
        $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/linear-algebra/kernels/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/linear-algebra/kernels/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
            cd $EXE_FILES/ && tmptime=`./$val`
    ...
    then
        ...
        $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/linear-algebra/solvers/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/linear-algebra/solvers/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
            cd $EXE_FILES/ && tmptime=`./$val`
    ...
    then
        ...
        $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/medley/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/medley/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
            cd $EXE_FILES/ && tmptime=`./$val`
    ...
    then
        ...
        if [ $val == "jacobi-1d" ];
        then
            $CLANG $NATIVE_JEMALLOC_FLAGS -mllvm -handle-higher-order -I $POLYBENCH/utilities -I $POLYBENCH/stencils/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/stencils/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        else
            $CLANG $NATIVE_JEMALLOC_FLAGS -I $POLYBENCH/utilities -I $POLYBENCH/stencils/$val $POLYBENCH/utilities/polybench.c $POLYBENCH/stencils/$val/$val.c $RESTRICT -DPOLYBENCH_TIME -o $EXE_FILES/$val $NATIVE_LIB_FLAGS -lm
        fi
        extime2=0.0
        for (( i = 0; i < $iter; i++ ))
        do
